...
public class VacationController {
    ...
    @Operation(description = "Get all Applies", responses = {
            ...
            @ApiResponse(responseCode = "400", ref = "badrequest"), @ApiResponse(responseCode = "500", ref = "internalServerApi"),

            @ApiResponse(responseCode = "200", description = "Succesfuly gel all appplies", content = @Content(mediaType = "application/json", examples = {@ExampleObject(value = "{\"code\" : 200, \"Status\" : \"Ok!\", \"Message\" :\"Successfully get all applies!\"}"),})),
...
//        List<Vacation> vacations = vacationService.findAll();
    ...
    public ResponseEntity<ResponeseApi_Dto> vaactionApply(@io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(mediaType = "application/json", examples = {@ExampleObject(value = "{\"username\" : 200, \"amoutn\" : \"Ok!\", \"date\" :\"Successfully get all applies!\"}")}
